...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-demo-manualtls
echo     https://github.com/tfynes-pivotal/tap-gitops-demo-manualtls
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-demo-manualtls --public
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-demo-manualtls
git branch -M main
